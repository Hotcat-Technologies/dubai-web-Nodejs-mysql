...
app.use(cors({ origin: ["http://localhost","http://51.20.143.83","https://salemalmakrani.net", "https://api.salemalmakrani.net"] }));//Add your front end url to avoid the cors error
app.use(logger('dev'));
