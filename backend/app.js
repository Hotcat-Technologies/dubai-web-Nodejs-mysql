...
app.use(cors({ origin: ["http://localhost","http://51.20.143.83","http://admin.salemalmakrani.net", "https://admin.salemalmakrani.net"] }));//Add your front end url to avoid the cors error
app.use(logger('dev'));
